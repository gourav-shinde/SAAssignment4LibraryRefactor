...
CLinkedList::CLinkedList() : m_count(0)
{
...
PointerBasedLinkedList::PointerBasedLinkedList() : CLinkedList(), m_head(nullptr)
{
...
ArrayBasedLinkedList::ArrayBasedLinkedList() : CLinkedList()
{
